    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          reached: "hsl(var(--status-reached))",
          "reached-foreground": "hsl(var(--status-reached-foreground))",
          started: "hsl(var(--status-started))",
          "started-foreground": "hsl(var(--status-started-foreground))",
          completed: "hsl(var(--status-completed))",
          "completed-foreground": "hsl(var(--status-completed-foreground))",
          qc: "hsl(var(--status-qc))",
          "qc-foreground": "hsl(var(--status-qc-foreground))",
